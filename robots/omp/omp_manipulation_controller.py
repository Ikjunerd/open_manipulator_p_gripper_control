...
class OmpManipulationController(BaseController):
    """ 
    ...
    def reset(
        ...
        self._t = 0
        self._pause = False
        self._cspace_controller.add_obstacle(self._obstacle)
    ...
    @property
    def rmpflow(self) -> RMPFlowController:
        """[summary]

        Returns:
            RMPFlowController: [description]
        """
        return self._cspace_controller